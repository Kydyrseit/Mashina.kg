...
Actions are only bound to methods at the point of instantiating the api_views.

    user_list = UserViewSet.as_view({'get': 'list'})
    user_detail = UserViewSet.as_view({'get': 'retrieve'})

Typically, rather than instantiate api_views from viewsets directly, you'll
...
class ViewSetMixin:
    ...
    def as_view(cls, actions=None, **initkwargs):
        """
        Because of the way class based api_views create a closure around the
