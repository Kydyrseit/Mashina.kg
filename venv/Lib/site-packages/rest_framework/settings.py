...
DEFAULTS = {
    ...
    # View configuration
    'VIEW_NAME_FUNCTION': 'rest_framework.api_views.get_view_name',
    'VIEW_DESCRIPTION_FUNCTION': 'rest_framework.api_views.get_view_description',

    # Exception handling
    'EXCEPTION_HANDLER': 'rest_framework.api_views.exception_handler',
