...
def swagger_auto_schema(method=None, methods=None, auto_schema=unset, request_body=None, query_serializer=None,
    ...
    :param str method: for multi-method api_views, the http method the options should apply to
    :param list[str] methods: for multi-method api_views, the http methods the options should apply to
    ...
    def decorator(view_method):
        ...
        if methods or method:
            assert available_http_methods, "`method` or `methods` can only be specified on @action or @api_view api_views"
